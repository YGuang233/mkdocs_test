// 这个文件的代码结合这个json的内容，我感觉是fastapi用来表示哪些项目使用了fastapi并把对应的信息给整理出来铺到html上，
// 但是去官网上看只有`https://fastapi.tiangolo.com/zh/external-links/#projects`这页里有对应的id的div元素`.github-topic-projects ul` 但没有ul后台在不断请求但是没实际体现
// 很可惜
...
async function main() {
    ...
    setupTermynal();
    // showRandomAnnouncement('announce-left', 5000) // 左广告
    // showRandomAnnouncement('announce-right', 10000) // 右广告
}
document$.subscribe(() => {
    main()
})
